...
1. Clone the repo
   ```sh
   git clone https://github.com/tharnyelilvannan/CharacterDriver.git
   ```
2. Change directory to project
   ```sh
   cd CharacterDriver
   ```
3. Change script file permissions
   ```sh
...
* [Understanding the Buffer in Kernel Read/Write Operations](https://medium.com/@deeppadmani98.2021/understanding-the-buffer-in-kernel-read-write-operations-b77e618a9ded)
...
[github-url]:https://github.com/tharnyelilvannan
